...
class DevCompiler extends AbstractCompiler
{
    public function __invoke(
        ...
        #[Option('No Posix',            'np')] bool $noPosix = false,
        ...
        $this->addOwnSrc($output, false, $prefix, $versionTag, false, !$noSysV, !$noPosix);
...
class PortCompiler extends AbstractCompiler
{
    public function __invoke(
        ...
        #[Option('Posix',           '', 'p')] bool $posix = true,
        ...
        $this->addBootsraptFiles();
        $this->addOwnSrc($output, true, $prefix, $versionTag, true, $sysv, $posix);
...
class GitHubCompiler extends AbstractCompiler
{
    public function __invoke(
        ...
        $this->addBootsraptFiles();
        $this->addOwnSrc($output, false, '/usr/local', $versionTag, true, true, true);
